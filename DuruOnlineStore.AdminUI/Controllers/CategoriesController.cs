...
namespace DuruOnlineStore.AdminUI.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(DuruStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await duruStoreContext.ToListAsync());
            //return _context.Categories != null ? 
            //            View(await duruStoreContext.ToListAsync());
            //            Problem("Entity set 'DuruStoreContext.Categories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DuruStoreContext.Categories'  is null.");
            }
            var category = await _context.Categories.FindAsync(id);
            if (category != null)
            {
